          ...
          <table class="table table-sm table-striped">
            <thead>
              <tr>
                ...
                <th>Post_id</th> <th>Content</th> <th>From_uid</th> <th>Comment_type</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$comment->post_id}}</td> <td>{{$comment->content}}</td> <td>{{$comment->from_uid}}</td> <td>{{$comment->comment_type}}</td>
